...
There are several ways of creating and defining confidence intervals: they are neither a single concept nor a simple concept. In general terms, confidence intervals (or confidence sets) consist of a subset of models *broadly consistent with the observed data*.
