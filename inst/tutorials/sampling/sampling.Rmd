...
TODO: include the analogy from Andy Field's book, that we're seeing more of the "picture" with increasing sample size. Get a picture in R and "sample" it with different sample sizes.
...
Homework: explore the sampling distribution of the standard deviation.